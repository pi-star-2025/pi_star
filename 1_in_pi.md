...
1 & 9 both indicate one tick of time. Whereas other numbers are more ambiguous, adding color. 
...
There is always just 2 initial .1's, because that is all that we can "see". The rest of the number after 3.14159 is direct evidence of the workings at the quantum level. It is evidence that even though we cannot see the colorful spirals created by the quantum dimension, they still are existing and work in very mathemtical ways.
